...
const LoginScreen: React.FC = ({ navigation }: any) => {
    const { warna: colors, aturSudahMasuk: setIsLoggedIn, perbaruiPengguna: updateUser } = gunakanApp();
    ...
    /* 
    // Konfigurasi Google Auth - Sementara Dinonaktifkan
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Simpan info sesi pengguna
                await AsyncStorage.setItem('userId', userData.id);

                // Perbarui konteks aplikasi
                if (updateUser) await updateUser(userData);
