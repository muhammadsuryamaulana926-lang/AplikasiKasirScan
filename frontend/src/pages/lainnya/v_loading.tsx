...
import { Spacing, FontSize, FontWeight, Colors } from '../../tema';
...
const LoadingDotsEnhanced = () => {
        ...
        Animated.loop(
            Animated.sequence([
                Animated.timing(animation, {
                    toValue: 4,
                    duration: 2000, // Animasi lebih lambat (2 detik)
    ...
    return (
        <View style={styles.dotsContainer}>
            {dots.map((index) => {
                // Tentukan warna berdasarkan nilai animasi
                // Titik berwarna oranye saat animasi mendekati indeks
