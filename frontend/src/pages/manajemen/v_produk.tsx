...
import { Product, Category } from '../../tipe';
...
const InventoryScreen: React.FC = ({ navigation }: any) => {
    ...
    const ambilDataProduk = useCallback(async () => {
        try {
    ...
    const hapusDataProduk = async () => {
        ...
        try {
            ...
            // Tutup modal konfirmasi dan modal form, lalu refresh list
    ...
    const renderItemProduk = useCallback(({ item, index }: { item: Product, index: number }) => (
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <Modal visible={isFormVisible} onClose={() => setIsFormVisible(false)} title={selectedProduct ? "Edit Produk" : "Tambah Produk"} size="lg">
                ...
                <Button title="Simpan Produk" onPress={simpanDataProduk} size="md" rounded />
            ...
            >
                <View style={{ alignItems: 'center', paddingVertical: Spacing.sm }}>
                    ...
                    <Text style={{ fontSize: FontSize.md, fontWeight: FontWeight.bold, color: colors.text, textAlign: 'center', marginBottom: Spacing.sm }}>
                        Hapus "{productToDelete?.name}"?
                    </Text>
                    <Text style={{ fontSize: FontSize.sm, color: colors.textSecondary, textAlign: 'center', marginBottom: Spacing.xl }}>
                        Produk akan dinonaktifkan dan tidak muncul di daftar. Tindakan ini tidak dapat dibatalkan.
                    </Text>
