...
import { Spacing, FontSize, FontWeight, BorderRadius, formatRupiah, Shadow } from '../../tema';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import api from '../../layanan/api';
import { Product } from '../../tipe';
...
const ScannerScreen = ({ navigation }: any) => {
    ...
    const { warna: colors, tambahKeKeranjang: addToCart } = gunakanApp();
